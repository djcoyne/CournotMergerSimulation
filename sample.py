...
firms={}
firms[1] = cfirm("Trader Joe's", [45, 25, 15], markets)
firms[2] = cfirm("Albertson's", [40, 18, 6], markets)
firms[3] = cfirm("Whole Foods", [55, 45, 19], markets)
firms[4] = cfirm("Sprouts", [11, 7, 4], markets)
...
CM = cournotMerge(F=firms, markets=markets, e=elasticity, p=price, MF=merge_index, E=efficiency)
